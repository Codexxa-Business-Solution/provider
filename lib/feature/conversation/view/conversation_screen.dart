  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(phone,
              style: ubuntuBold.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).primaryColorLight)
            ),
          ],
        ),
      ...
      body: GetBuilder<ConversationController>(
        ...
        String customerID = Get.find<UserProfileController>().providerModel!.content!.providerInfo!.userId!;
