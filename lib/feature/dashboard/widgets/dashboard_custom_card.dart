...
class TopCardItem extends StatelessWidget {
  ...
  const TopCardItem({Key? key,this.curveColor,required this.amount,required this.title,required this.cardColor,this.height,required this.iconData}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL), color: cardColor),
