...
import 'package:demandium_provider/feature/reporting/widgets/Business_report_bar_chart.dart';
import 'package:demandium_provider/feature/reporting/widgets/business_report_earning_list.dart';
import 'package:demandium_provider/feature/reporting/widgets/business_report_line_chart.dart';
import 'package:demandium_provider/feature/reporting/widgets/business_report_expense_listview.dart';
import 'package:demandium_provider/feature/reporting/widgets/business_report_overview_list.dart';
import 'package:demandium_provider/feature/reporting/widgets/business_report_statistics.dart';
import 'package:get/get.dart';

class BusinessReportView extends StatelessWidget {
  final String fromPage;
  const BusinessReportView({Key? key, required this.fromPage}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BusinessReportController>(
      ...
      return reportController.loading
          ? Center(child: CircularProgressIndicator())
          :CustomScrollView(
            controller: reportController.scrollController,
            slivers: [

              SliverToBoxAdapter(child: BusinessReportStatistics(fromPage: fromPage,reportController:reportController)),


              SliverToBoxAdapter(
                  child: fromPage=='expense'
                      ? BusinessReportBarChart() : BusinessReportLineChart(fromPage: fromPage)),
