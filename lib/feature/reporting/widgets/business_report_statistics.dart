...
import 'package:demandium_provider/feature/reporting/widgets/business_report_statistics_card.dart';
...
class BusinessReportStatistics extends StatelessWidget {
  ...
  const BusinessReportStatistics({Key? key, required this.fromPage, required this.reportController}) : super(key: key);
    ...
    if(fromPage!='overview'){
      ...
      return GetBuilder<BusinessReportController>(builder:(reportController){
        ...
        reportController.businessReportOverviewModel?.content?.amounts?.forEach((element) {
          discount = element.discountByProvider??0;
          couponDiscount = element.couponDiscountByProvider??0;
          campaignDiscount = element.campaignDiscountByProvider??0;
              ...
              child: Row(
                children: [
                  BusinessReportStatisticsCard(
                    ...
                    titleAmount: netProfit.toString(),
                    title: 'net_profit',
                  ),
