...
class BusinessReportController extends GetxController with GetSingleTickerProviderStateMixin{
  ...
  Future<void> getBusinessReportOverviewData(int offset,{bool reload = false}) async {
    ...
    Response response = await reportRepo.getBusinessReportOverviewData(offset, _data);
  ...
  void getEarningChartData(String type) {
    ...
    if(type !='year'){
      ...
      print("TimelineLength: ${timeLine.length}");
    }
    else{
