...
import 'package:demandium_provider/feature/subscriptions/model/my_subscription_model.dart';
 ...
 class PriceConverter {
  ...
  static String percentageCalculation(String price, String discount, String discountType) {
   ...
   static Discount _getDiscount(List<ServiceDiscount>? serviceDiscountList, double? _discountAmount, String? _discountAmountType) {
     ...
     if(serviceDiscount != null){
       double? _getDiscount = serviceDiscount.discount?.discountAmount;
