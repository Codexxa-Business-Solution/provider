  ...
  Widget build(BuildContext context) {
    return GetBuilder<DashboardController>(builder: (dashboardController){
      return CustomDropDown(
          type: widget.title,
          hint:  widget.type=="Year"? dashboardController.selectedYear: dashboardController.selectedMonth,
          errorText: '',
          ...
          onChanged: (String? value) {
            if(widget.type=="Month"){
              dashboardController.selectedMonth!=value!;
              int index =  widget.itemList.indexOf(value)+1;
              dashboardController.changeDashboardDropdownValue(index.toString(),value,widget.type);
            }else if(widget.type=="Year"){
              dashboardController.changeDashboardDropdownValue(value!,value,widget.type);
            }
          }
      );
    });
